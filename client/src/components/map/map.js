...
export default function Map() {
  ...
  const wineList = [
    {
    name: "Menti", vintage: 2018, address: "UFFICI /HEADQUARTER, via Dr. Bruzzo, 24, 36053 Gambellara VI, Italy"
    // coords: {lat: 45.4598, lng: 11.3401}
    },
    {
    name: "Raventos i Blanc", vintage: 2017, address: "Plaça del Roure, S/N, 08770 Sant Sadurní d'Anoia, Barcelona, Spain"
    // coords: { lat: 41.4263208, lng: 1.7845831 }
    },
    {
    name: "Mirco Mariotti", vintage: "NV", address: "Via Rosa Bardelli, 12, 44011 Argenta FE, Italy"
    // coords: { lat: 44.6596655, lng: 11.7785897 }
    },
    {
    name: "Txakoli Ameztoi", vintage: 2019, address: "Lugar Barrio Eitzaga, 10, 20808 Eitzaga, SS, Spain",
    // coords: { lat: 43.2938, lng: -2.1983 }
    },
    {
    name: "Domaine Mercouri", vintage: 2017, address: "Korakochori 271 00, Greece",
